...
final class Utilities {
    ...
    static class BubbleText {
        ...
        BubbleText(Context context) {
            ...
            if (false) {
                Log.d(TAG, "mBitmapWidth=" + mBitmapWidth + " mBitmapHeight=" + mBitmapHeight + " w="
        ...
        Bitmap createTextBitmap(String text) {
            ...
            StaticLayout layout = new StaticLayout(text, mTextPaint, (int) mTextWidth, Alignment.ALIGN_CENTER, 1, 0,
                    true);
